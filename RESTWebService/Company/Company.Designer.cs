...
namespace Company {
    ...
    public partial class Company : global::System.Data.DataSet {
        ...
        public partial class EmployeeDataTable : global::System.Data.TypedTableBase<EmployeeRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public EmployeeRow AddEmployeeRow(int Id, string FirstName, string LastName, string Designation) {
...
namespace Company.CompanyTableAdapters {
    ...
    public partial class EmployeeTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Employee] ([Id], [FirstName], [LastName], [Designation]) VALUE" +
                "S (@Id, @FirstName, @LastName, @Designation);\r\nSELECT Id, FirstName, LastName, D" +
                "esignation FROM Employee WHERE (Id = @Id)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Employee] SET [Id] = @Id, [FirstName] = @FirstName, [LastName] = @LastName, [Designation] = @Designation WHERE (([Id] = @Original_Id) AND ((@IsNull_FirstName = 1 AND [FirstName] IS NULL) OR ([FirstName] = @Original_FirstName)) AND ((@IsNull_LastName = 1 AND [LastName] IS NULL) OR ([LastName] = @Original_LastName)) AND ((@IsNull_Designation = 1 AND [Designation] IS NULL) OR ([Designation] = @Original_Designation)));
SELECT Id, FirstName, LastName, Designation FROM Employee WHERE (Id = @Id)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::Company.Properties.Settings.Default.CompanyConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Id, FirstName, LastName, Designation FROM dbo.Employee";
        ...
        public virtual int Fill(Company.EmployeeDataTable dataTable) {
        ...
        public virtual Company.EmployeeDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            Company.EmployeeDataTable dataTable = new Company.EmployeeDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(Company.EmployeeDataTable dataTable) {
        ...
        public virtual int Delete(int Original_Id, string Original_FirstName, string Original_LastName, string Original_Designation) {
        ...
        public virtual int Insert(int Id, string FirstName, string LastName, string Designation) {
        ...
        public virtual int Update(int Id, string FirstName, string LastName, string Designation, int Original_Id, string Original_FirstName, string Original_LastName, string Original_Designation) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string FirstName, string LastName, string Designation, int Original_Id, string Original_FirstName, string Original_LastName, string Original_Designation) {
            return this.Update(Original_Id, FirstName, LastName, Designation, Original_Id, Original_FirstName, Original_LastName, Original_Designation);
        }
    }
